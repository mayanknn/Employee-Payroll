...
import smtplib
#=====================================CONNECTION=======================================#
link=mh.connect(host="localhost",user="root",password="Harshil9426874317@05/11/2004")
...
def main():
        ...
        def login():
            ...
            if ent1.get()=="" or ent2.get()=="":
                ...
                if row==None:
                    ...
                    Logo=Logo.resize((390,190),Image.ANTIALIAS)
    ...
    re1=m.resize((1550,765),Image.ANTIALIAS)   #resize,,,no blur
    ...
    resized=mayank.resize((30,30),Image.ANTIALIAS)
    ...
    resized1=harshil.resize((30,30),Image.ANTIALIAS)
